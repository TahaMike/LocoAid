...
class AppTheme {
  ...
  static const Color secondaryColor = Color.fromARGB(255, 183, 218, 252); // from image
  ...
  static const Color iconColor = Color(0xFF2B60A1);
  static const Color iconBgColor = Color(0xFF98C6F2);
